...
export default class WorldScene extends Phaser.Scene {
  ...
  create(data) {
    ...
    if (data.dimensionNumber) {
      ...
      this.exothiumWorldClient = new ExothiumWorldClient('192.168.0.78', 1337, () => {
        //im ready
    ...
    this.menuGUI = new dat.GUI();
        ...
        other.add({
            mainMenu: () => {
                ...
                this.hudScene.stopScenes();
                this.scene.stop();
                this.game.scene.start(MainMenuScene.SCENE_KEY);
  ...
  private drawHexCloud(tile: Tile) {
    ...
    private mapInteractiveScene() {
        ...
        this.circleMapArea.on('pointerdown', (pointer, localX, localY) => {
            ...
            this.hudScene.tileWindowScene.updateTileInfo(tile);
        });
    }
